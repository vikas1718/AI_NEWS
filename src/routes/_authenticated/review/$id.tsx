...
function ReviewEdition() {
  ...
  const approve = useMutation({
    ...
    onSuccess: () => {
      ...
      navigate({ to: "/published/$id", params: { id } });
    },
        ...
        {canDecide ? (
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="mt-2 text-[11px] text-muted-foreground">
              <Sparkles className="inline h-3 w-3" /> Approval triggers PDF + e-paper + audio +
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              This edition is still being edited. Decision controls appear after an editor sends it
              for approval.
            </p>
          </div>
        )}
